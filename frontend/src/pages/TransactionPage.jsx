...
const TransactionPage = () => {
	...
	return (
		<div className='min-h-screen flex justify-center items-center bg-black px-6'>
			<form
				className='w-full max-w-xl bg-zinc-900 p-8 rounded-2xl border border-zinc-800 flex flex-col gap-5'
			...
			>
				...
				<button
					className='bg-gradient-to-r from-pink-500 to-purple-500 p-4 rounded-xl text-white font-bold'
					type='submit'
					disabled={updating}
				>
					{updating
